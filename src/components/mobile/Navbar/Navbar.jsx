...
export default function Navbar() {
  return (
    <>
      <div className="min-w-full min-h-full relative flex flex-row items-center justify-center bg-[#1F1F1F] dark:bg-[#1F1F1F] ">
        <nav className="grid grid-cols-4 gap-1 min-h-full min-w-full mt-2 ">
          <NavLink to="/" className="flex flex-col items-center justify-center">
            {({ isActive }) =>
              isActive ? (
                <IconHomeFilled size={48} color={"#ffffff"} />
              ) : (
                <IconHome stroke={2} size={48} color={"#ffffff"} />
              )
            }
          ...
          >
            {({ isActive }) =>
              isActive ? (
                <IconUserFilled size={48} color={"#ffffff"} />
              ) : (
                <IconUser stroke={2} size={48} color={"#ffffff"} />
              )
            }
